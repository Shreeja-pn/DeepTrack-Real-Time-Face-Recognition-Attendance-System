...
Detect faces in each frame using YOLOv8

Extract facial embeddings using DeepFace

Compare embeddings with stored data using a threshold

Mark attendance automatically on successful match

📧 Send attendance confirmation email to the registered student
